...
public class AdatPerzisztencia {
    ...
    public static void saveGame(AmobaJatek jatek) {
        String sql = "MERGE INTO saved_games (id, player1_name, player2_name, board_size, win_length, current_player_index, board_state) KEY(id) VALUES (?, ?, ?, ?, ?, ?, ?)";
        ...
        try (Connection conn = DatabaseManager.getConnection(); PreparedStatement pstmt = conn.prepareStatement(sql)) {
            ...
            pstmt.executeUpdate();
            System.out.println("Játék sikeresen mentve az adatbázisba!");
    ...
    public static AmobaJatek loadGame() {
        ...
        try (Connection conn = DatabaseManager.getConnection(); PreparedStatement pstmt = conn.prepareStatement(sql); ResultSet rs = pstmt.executeQuery()) {
            ...
            if (rs.next()) {
                ...
                System.out.println("Játék sikeresen betöltve az adatbázisból.");
